...
class DPTSpider(scrapy.Spider):
	...
	def parse_item(self,response):
		item = DapentiItem()
		print "dep2 " + response.url + str(response.status)
		...
		if item['title'] is None:
			return None
		item['time'] = response.xpath('/html/body/table/tbody/tr/td[1]/div/table[1]/tbody/tr[2]/td/table[1]/tbody/tr/td/div/span/text()').extract_first()
